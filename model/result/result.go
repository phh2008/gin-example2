...
func FailMsg[T any](msg string) *Result[T] {
	if msg == "" {
		msg = exception.SysError.Message
	}
	return &Result[T]{Code: exception.SysError.Code, Message: msg, TimeStamp: time.Now().UnixMilli()}
}
